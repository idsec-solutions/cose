...
/*
    ...
    public ECGenParameterSpec GetCurve2() throws CoseException {
        if (COSEKey.this.get(KeyKeys.KeyType) != KeyKeys.KeyType_EC2) throw new CoseException("Not an EC2 key");
    ...
    static public COSEKey generateKey(AlgorithmID algorithm) throws CoseException {
     ...
     */
    static public COSEKey generateKey(AlgorithmID algorithm, String parameters) throws CoseException {
     ...
     * @throws CoseException
     */
    static public COSEKey generateKey(AlgorithmID algorithm, String parameters, Provider provider) throws CoseException {
        COSEKey returnThis;
        switch(algorithm) {
            case ECDSA_256:
    ...
    static public COSEKey generateKey(CBORObject curve) throws CoseException {
        return generateKey(curve, null);
    }

    static public COSEKey generateKey(CBORObject curve, Provider provider) throws CoseException {
        String curveName;
        COSEKey returnThis;
    ...
    static private COSEKey generateECDHKey(String curveName, CBORObject curve, Provider provider) throws CoseException {
        try {
    ...
    static private COSEKey generateECDSAKey(String curveName, CBORObject curve, Provider provider) throws CoseException {
        try {
    ...
    private void CheckOkpKey() throws CoseException {
     ...
     static private COSEKey generateOkpKey(String curveName, CBORObject curve, Provider provider) throws CoseException {
        try {
            switch (curveName) {
                case "Ed25519":
    ...
    static private COSEKey generateRSAKey(int keySize, Provider provider) throws CoseException {
        try {
            KeyPairGenerator gen = provider != null ?
